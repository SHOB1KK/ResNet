...
namespace ResNet.Infrastructure.Migrations
{
    ...
    [Migration("20250719061344_ChangedRequsetServices")]
    partial class ChangedRequsetServices
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RestaurantRequest", b =>
                {
                    ...
                    b.Property<string>("OwnerResumeUrl")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ResNet.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("ResNet.Domain.Entities.Order", null)
                        .WithMany("OrderItems")
